...
class CandidatsControllerTest < ActionController::TestCase
  ...
  test "should create candidat" do
    assert_difference('Candidat.count') do
      post :create, candidat: { elu: @candidat.elu, nom: @candidat.nom, parti: @candidat.parti, prenom: @candidat.prenom, voix: @candidat.voix }
    end
  ...
  test "should update candidat" do
    patch :update, id: @candidat, candidat: { elu: @candidat.elu, nom: @candidat.nom, parti: @candidat.parti, prenom: @candidat.prenom, voix: @candidat.voix }
    assert_redirected_to candidat_path(assigns(:candidat))
  end
